...
const AVAILABLE_MODULES = [
  'Overview','Planning','HR & Admin','Procurement','Tender Management','Stores',
  'QS & Billing','Finance','Bill Tracker','Quality (QA/QC)','HSE & Safety',
  'Reports','Assets & IT','Subcontractors','DMS','Documents','Administration',
  'Automation Ideas','Approval Engine',
];

const ROLE_MODULE_PRESETS = {
  management:            ['Overview','Planning','Procurement','Tender Management','Stores','QS & Billing','Finance','Bill Tracker','Quality (QA/QC)','HSE & Safety','Subcontractors','Reports','Assets & IT','DMS','Documents','Automation Ideas','Approval Engine'],
  project_head:          ['Overview','Planning','Procurement','Stores','QS & Billing','Subcontractors','Quality (QA/QC)','HSE & Safety','Reports','Assets & IT','Documents','Approval Engine'],
  project_manager:       ['Overview','Planning','Procurement','Stores','QS & Billing','Subcontractors','Quality (QA/QC)','HSE & Safety','Reports','Documents'],
  planning_engineer:     ['Overview','Planning','Documents','Reports'],
  site_engineer:         ['Overview','Planning','Stores','Quality (QA/QC)','HSE & Safety','Documents'],
  qs_engineer:           ['Overview','QS & Billing','Subcontractors','Bill Tracker','Reports','Documents'],
  billing_engineer:      ['Overview','QS & Billing','Subcontractors','Finance','Bill Tracker','Reports'],
  ...
  accountant:            ['Overview','Finance','Procurement','QS & Billing','Subcontractors','Bill Tracker','Reports'],
  accounts_manager:      ['Overview','Finance','Procurement','QS & Billing','Subcontractors','Bill Tracker','Reports'],
  finance_manager:       ['Overview','Finance','Procurement','QS & Billing','Subcontractors','Bill Tracker','Reports'],
