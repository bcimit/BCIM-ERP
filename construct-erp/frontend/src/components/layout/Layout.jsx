...
const navGroups = [
  ...
  { label: 'Procurement', items: [
    ...
    { to: '/procurement/po?series=POTQS',  icon: ShoppingCart,  label: 'PO — TQS (POTQS)' },
    { to: '/procurement/po?series=PODQS',  icon: ShoppingCart,  label: 'PO — DQS (PODQS)' },
    ...
    { to: '/procurement/work-orders?series=WOTQS', icon: Hammer, label: 'WO — TQS (WOTQS)' },
    { to: '/procurement/work-orders?series=WODQS', icon: Hammer, label: 'WO — DQS (WODQS)' },
...
const NAV_SECTIONS = {
  ...
  'Procurement': [
    ...
    { label: 'PO — TQS',         paths: ['/procurement/po'] },
    { label: 'WO — TQS',         paths: ['/procurement/work-orders'] },
    { label: 'PO Register',      paths: ['/procurement/po-register','/procurement/po-amendments'] },
    { label: 'WO Register',      paths: ['/procurement/wo-register'] },
...
const PROC_SHORTCUTS = [
  { label: 'PO — TQS',          to: '/procurement/po?series=POTQS',               icon: ShoppingCart  },
  { label: 'PO — DQS',          to: '/procurement/po?series=PODQS',               icon: ShoppingCart  },
  { label: 'WO — TQS',          to: '/procurement/work-orders?series=WOTQS',      icon: Hammer        },
  { label: 'WO — DQS',          to: '/procurement/work-orders?series=WODQS',      icon: Hammer        },
