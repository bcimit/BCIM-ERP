import{r as v,j as e,R as ze,k as Oe}from"./vendor-react-Db2HHDvz.js";import{e as je,u as ne,f as se}from"./vendor-data-41-IeaEn.js";import{Q as ye}from"./index-rJwld4ZI.js";import{u as Qe}from"./vendor-forms-CYhUWCSQ.js";import{a8 as Y,p as We}from"./index-Cd-70lHF.js";import{d as c,c as $,z as j}from"./vendor-ui-BbXjBtRR.js";import{aV as xe,aT as ve,f as de,b as Ne,M as He,a4 as ue,ac as ge,a3 as Ve,af as ie,ch as Ge,ci as Ke,cj as Xe,ck as Ze,aw as we,b2 as Je,b3 as es,bU as le,ap as ss,R as oe,V as ts,w as _e,aK as ke,S as as,X as te,bD as rs,cl as ls,az as Se,a6 as is,cm as ns,aW as ds,aU as os,ak as cs,ae as xs}from"./vendor-icons-BwrELoP_.js";import{R as ps}from"./RecordAttachments-DIOQYyuB.js";function M(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function ms(){try{const h=await(await fetch("/bcim-logo.png")).blob();return await new Promise(n=>{const m=new FileReader;m.onloadend=()=>n(m.result),m.readAsDataURL(h)})}catch{return null}}function bs({value:t,title:h,subtitle:n,metaLabel:m="Asset Tag",metaValue:I,assetId:u,serialNumber:k,extraFields:R=[],className:N,size:E=130,companyName:w="BCIM Engineering Pvt Ltd",labelType:F="ASSET",labelSubtitle:r="Asset Management"}){var X;const L=v.useRef(null),y=String(u||I||t||"").trim(),S=String(h||"").trim(),C=String(k||((X=R.find(b=>/serial/i.test(b.label||"")))==null?void 0:X.value)||"").trim(),g=String(t||y||S||"").trim(),a=[`Company: ${w}`,`Item: ${S||"-"}`,`Serial: ${C||"-"}`,`Asset ID: ${y||g||"-"}`].join(`
